...
public class GridViewPager extends LinearLayout {
    ...
    private void initView() {
        ...
        View view = inflater.inflate(R.layout.gvp_view, this);
    ...
    public GridViewPager initWithData(List<GridItem> list) {
        ...
        for (int i = 0; i < pageCount; i++) {
            //每个页面都是inflate出一个新实例
            GridView gridView = (GridView) inflater.inflate(R.layout.gvp_gridview, mPager, false);
        ...
        mPageIndicatorView.setSelectedColor(ContextCompat.getColor(getContext(),R.color.gvp_colorPrimary));
